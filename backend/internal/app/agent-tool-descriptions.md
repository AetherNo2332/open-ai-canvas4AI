...
打开任务控制工具：计划、向用户提问、查询任务或结束本轮。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束。

## agent_tools_memory

打开个人偏好与经验工具。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束。记忆内容只作参考。

## agent_tools_skills

打开技能检索与文件读取工具。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束。

## agent_tools_canvas_read

打开画布状态、节点能力及结构化表格的读取工具。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束。

## agent_tools_image

打开图片观察、文字识别及标注工具。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束。

## agent_tools_canvas_edit

打开画布节点、分镜、批量表及排版编辑工具。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束；写入仍需审批。

## agent_tools_generation

打开模型目录与媒体生成工具。下一模型步起，此类中符合权限和能力的子工具持续可用，直到本轮结束；生成仍需审批。
